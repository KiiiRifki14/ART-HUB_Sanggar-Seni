...
<head>
    ...
    <title>Atur Ulang Kata Sandi | ART-HUB Sanggar Cahaya Gumilang</title>
    ...
    <div class="w-full lg:w-[55%] xl:w-1/2 h-full bg-surface-container-lowest flex flex-col justify-center relative z-10 shadow-[-30px_0_60px_rgba(54,31,26,0.06)] overflow-y-auto"
        ...
        <div class="w-full max-w-md mx-auto px-8 py-12">
            ...
            <div class="mb-10" data-aos="fade-up" data-aos-delay="200">
                ...
                <p class="font-label text-sm uppercase tracking-[0.2em] text-outline">Simpan Kata Sandi Baru</p>
            </div>

            {{-- Validation Errors --}}
            @if ($errors->any())
            <div class="mb-6 p-4 bg-red-50 rounded-lg" data-aos="fade-up" data-aos-delay="255">
            ...
            {{-- Session Status --}}
            @if (session('status'))
            <div class="mb-6 p-4 bg-green-50 rounded-lg" data-aos="fade-up" data-aos-delay="255">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="space-y-6 mb-8">
                    ...
                    <div class="relative group" data-aos="fade-up" data-aos-delay="300">
                        <input class="peer w-full bg-surface-container-low text-on-surface-variant/80 font-body px-5 py-4 pt-6 rounded-lg border-none focus:ring-0 cursor-not-allowed"
                            id="email" name="email" type="email" value="{{ session('reset_email') }}" readonly required>
                    ...
                    <div class="relative group" data-aos="fade-up" data-aos-delay="350">
                        <input class="peer w-full bg-surface-container-low text-on-surface font-body px-5 py-4 pt-6 rounded-lg border-none focus:ring-0 focus:bg-surface-container-lowest focus:shadow-[0_8px_24px_rgba(78,52,46,0.04)] transition-all placeholder-transparent text-center tracking-widest font-bold text-lg"
                            id="otp_code" name="otp_code" placeholder="Kode OTP" type="text" required maxlength="6" autocomplete="one-time-code">
                        <label class="absolute left-5 top-2 font-label text-xs uppercase tracking-widest text-outline transition-all w-full text-left
                            ...
                            for="otp_code">Kode OTP (6 Digit)</label>
                    ...
                    <div class="relative group" data-aos="fade-up" data-aos-delay="400">
                        <input class="peer w-full bg-surface-container-low text-on-surface font-body px-5 py-4 pt-6 rounded-lg border-none focus:ring-0 focus:bg-surface-container-lowest focus:shadow-[0_8px_24px_rgba(78,52,46,0.04)] transition-all placeholder-transparent pr-14"
                            id="password" name="password" placeholder="Kata Sandi Baru" type="password" required autocomplete="new-password">
                        <label class="absolute left-5 top-2 font-label text-xs uppercase tracking-widest text-outline transition-all
                            peer-placeholder-shown:text-sm peer-placeholder-shown:top-5 peer-placeholder-shown:normal-case peer-placeholder-shown:tracking-normal
                            peer-focus:text-xs peer-focus:uppercase peer-focus:tracking-widest peer-focus:top-2 peer-focus:text-secondary"
                        ...
                        <button type="button" onclick="togglePassword(this)"
                            class="absolute right-5 top-1/2 -translate-y-1/2 text-outline hover:text-primary transition-colors z-10">
                    ...
                    <div class="relative group" data-aos="fade-up" data-aos-delay="450">
                        <input class="peer w-full bg-surface-container-low text-on-surface font-body px-5 py-4 pt-6 rounded-lg border-none focus:ring-0 focus:bg-surface-container-lowest focus:shadow-[0_8px_24px_rgba(78,52,46,0.04)] transition-all placeholder-transparent pr-14"
                            id="password_confirmation" name="password_confirmation" placeholder="Konfirmasi Kata Sandi Baru" type="password" required autocomplete="new-password">
                        <label class="absolute left-5 top-2 font-label text-xs uppercase tracking-widest text-outline transition-all
                            peer-placeholder-shown:text-sm peer-placeholder-shown:top-5 peer-placeholder-shown:normal-case peer-placeholder-shown:tracking-normal
                            peer-focus:text-xs peer-focus:uppercase peer-focus:tracking-widest peer-focus:top-2 peer-focus:text-secondary"
                            for="password_confirmation">Konfirmasi Kata Sandi</label>
                        <span class="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-secondary transition-all duration-300 peer-focus:w-full rounded-full"></span>
                        <button type="button" onclick="togglePassword(this)"
                            class="absolute right-5 top-1/2 -translate-y-1/2 text-outline hover:text-primary transition-colors z-10">
                            <span class="material-symbols-outlined text-xl">visibility_off</span>
            ...
            {{-- Footer --}}
            <div class="mt-16 pt-8 border-t border-outline-variant/20 text-center" data-aos="fade-up" data-aos-delay="550">
                <p class="font-body text-sm text-on-surface-variant">
                    ...
                    <a class="inline-block ml-2 font-label text-xs uppercase tracking-widest text-primary font-bold hover:text-secondary transition-colors"
                        href="{{ route('login') }}">Kembali ke Login</a>
                </p>
            </div>
