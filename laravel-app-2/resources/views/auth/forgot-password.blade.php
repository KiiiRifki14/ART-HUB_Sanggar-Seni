...
<head>
    ...
    <title>Lupa Kata Sandi | ART-HUB Sanggar Cahaya Gumilang</title>
    ...
    <div class="w-full lg:w-[55%] xl:w-1/2 h-full bg-surface-container-lowest flex flex-col justify-center relative z-10 shadow-[-30px_0_60px_rgba(54,31,26,0.06)] overflow-y-auto"
        ...
        <div class="w-full max-w-md mx-auto px-8 py-12">
            ...
            <div class="mb-10" data-aos="fade-up" data-aos-delay="200">
                ...
                <p class="font-label text-sm uppercase tracking-[0.2em] text-outline">Atur Ulang Kata Sandi</p>
            </div>

            {{-- Information box --}}
            <div class="mb-8 p-4 bg-primary/5 rounded-lg border border-primary/10 text-on-surface-variant text-sm leading-relaxed" data-aos="fade-up" data-aos-delay="250">
                Lupa kata sandi Anda? Tidak masalah. Masukkan alamat email terdaftar Anda di bawah ini dan kami akan mengirimkan kode OTP untuk verifikasi sebelum Anda dapat membuat kata sandi baru.
            </div>

            {{-- Validation Errors --}}
            @if ($errors->any())
            <div class="mb-6 p-4 bg-red-50 rounded-lg" data-aos="fade-up" data-aos-delay="300">
            ...
            {{-- Session Status --}}
            @if (session('status'))
            <div class="mb-6 p-4 bg-green-50 rounded-lg" data-aos="fade-up" data-aos-delay="300">
            ...
            {{-- Navigation Footer --}}
            <div class="mt-16 pt-8 border-t border-outline-variant/20 text-center" data-aos="fade-up" data-aos-delay="450">
