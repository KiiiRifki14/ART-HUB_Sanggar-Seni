...
/**
 * BUG-6 FIX: Memperbaiki pesan bentrok jadwal di SP agar lebih informatif.
 * Sebelumnya: "[EVENT_COLLISION]", "[DAY_JOB_CONFLICT]"
 * Sesudahnya:  "⚠️ Bentrok Event", "⏰ Jam Kerja Aktif"
 */
    ...
    public function up(): void
    {
        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                DECLARE v_conflict_type VARCHAR(255);
                ...
                read_loop: LOOP
                    ...
                    IF v_has_day_job = TRUE
                       ...
                       AND p_end_time > '09:00:00' THEN
                        IF v_conflict_type IS NULL THEN
                            SET v_conflict_type = '⏰ Kemungkinan bentrok jam kerja utama (09:00-17:00)';
                        ELSE
                            SET v_conflict_type = CONCAT(v_conflict_type, ' + ⏰ bentrok jam kerja');
                        END IF;
                    END IF;
                    ...
                    IF v_conflict_type IS NOT NULL THEN
                        ...
                        SET v_collisions = CONCAT(v_collisions,
                            ...
                            ' — ', v_conflict_type,
                            IF(v_has_day_job AND v_day_job_desc IS NOT NULL, CONCAT(' [Pekerjaan: ', v_day_job_desc, ']'), ''),
