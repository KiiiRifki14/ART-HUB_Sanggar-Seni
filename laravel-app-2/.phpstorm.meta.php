...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\ART-HUB_Sanggar Seni\laravel-app-2\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\ART-HUB_Sanggar Seni\\laravel-app-2\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.mailers.smtp.local_domain','mail.mailers.smtp.stream.ssl.allow_self_signed','mail.mailers.smtp.stream.ssl.verify_peer','mail.mailers.smtp.stream.ssl.verify_peer_name','mail.mailers.ses.transport',
...
'geocoding.search','geocoding.reverse','geocoding.autocomplete',
'dashboard','notifications.read','notifications.read_all','admin.cms.index','admin.cms.update',
'admin.dashboard','admin.bookings.index','admin.bookings.create','admin.bookings.show','admin.bookings.manual.store',
'admin.bookings.confirm','admin.bookings.update_price','admin.bookings.update_price','admin.events.index','admin.events.show',
'admin.events.plotting','admin.events.plotting.store','admin.events.update_coordinates','admin.events.mark_completed','admin.personnel.index',
'admin.personnel.create','admin.personnel.store','admin.personnel.edit','admin.personnel.update','admin.personnel.destroy',
'admin.personnel.approve','admin.personnel.reject','admin.personnel.toggle_status','admin.personnel.update_event_status','admin.payments.index',
'admin.costumes.index','admin.costumes.usage.return','admin.costumes.rental.return','admin.costumes.create-asset','admin.costumes.store-asset',
'admin.costumes.edit-asset','admin.costumes.update-asset','admin.costumes.destroy-asset','admin.costumes.store-vendor-api','admin.costumes.create-rental',
'admin.costumes.store-rental','admin.costumes.edit-rental','admin.costumes.update-rental','admin.financials.index','admin.financials.export_pdf',
'admin.financials.post_event','admin.financials.operational_costs.update','admin.cancellations.index','admin.bookings.cancel','admin.cancellations.penalty_settings',
'admin.cancellations.approve','admin.cancellations.reject','admin.rehearsals.index','admin.rehearsals.create','admin.rehearsals.store',
'admin.events.monitoring','admin.events.monitoring.show','admin.bookings.dp_verification','admin.bookings.reject_proof','admin.bookings.full_payment',
'admin.bookings.confirm_cash','admin.bookings.reject_full_proof','admin.bookings.full_cash_payment','admin.financials.post_event_list','admin.financials.operational_costs.store',
'admin.catalogs.index','admin.catalogs.create','admin.catalogs.store','admin.catalogs.edit','admin.catalogs.update',
'admin.catalogs.destroy','admin.catalogs.toggle','admin.profile.edit','admin.profile.update','admin.profile.password',
'personnel.pending','personnel.dashboard','personnel.attendance.check_in','personnel.rehearsals.check_in','personnel.profile.edit',
'personnel.profile.update','personnel.profile.password','personnel.keuangan','personnel.unavailability.store','klien.dashboard',
'klien.bookings.create','klien.bookings.store','klien.bookings.show','klien.bookings.upload_proof','klien.bookings.upload_full_proof',
'klien.bookings.feedback','klien.bookings.cancel','klien.profile.edit','klien.profile.update','klien.profile.password',
'register','otp.register.send','login',
'password.request','password.email','password.reset.otp.form','password.store','verification.notice',
'verification.verify','verification.send','password.confirm','password.update',
'logout','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.bookings.create','admin.bookings.dp-verification','admin.bookings.index','admin.bookings.show','admin.cancellations.index',
'admin.catalogs.create','admin.catalogs.edit','admin.catalogs.index','admin.cms.index','admin.costumes.create-asset',
'admin.costumes.create-rental','admin.costumes.edit-asset','admin.costumes.edit-rental','admin.costumes.index','admin.dashboard',
'admin.events.index','admin.events.monitoring','admin.events.monitoring-detail','admin.events.plotting','admin.events.show',
'admin.financials.index','admin.financials.pdf','admin.financials.post-event','admin.financials.post-event-list','admin.payments.index',
'admin.personnel.create','admin.personnel.edit','admin.personnel.index','admin.profile.edit','admin.rehearsals.create',
'admin.rehearsals.index','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.reset-password-otp','auth.verify-email','components.application-logo','components.auth-session-status',
'components.danger-button','components.dropdown','components.dropdown-link','components.gold-modal','components.input-error',
'components.input-label','components.modal','components.nav-link','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.text-input','dashboard','emails.otp','klien.bookings.create',
'klien.bookings.show','klien.dashboard','klien.profile.edit','layouts.admin','layouts.app',
'layouts.guest','layouts.klien','layouts.navigation','layouts.personnel','pagination::bootstrap-4',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','personnel.dashboard','personnel.keuangan',
'personnel.pending','personnel.profile_edit','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default','vendor.pagination.semantic-ui',
...
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.ART-HUB_Sanggar Seni.laravel-app-2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','MAIL_MAILER',
