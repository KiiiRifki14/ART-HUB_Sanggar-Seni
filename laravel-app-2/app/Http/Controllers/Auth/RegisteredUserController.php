...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($role === 'personel') {
            ...
            // FIX A-09: Proses specialty dari input request, bukan hardcoded 'penari'
            // Validasi whitelist nilai yang diperbolehkan untuk mencegah injection
            $allowedSpecialties = ['penari', 'pemusik', 'multi_talent'];
            $specialty = in_array($request->specialty, $allowedSpecialties)
                ? $request->specialty
                : 'penari'; // Fallback jika input tidak ada/tidak valid
